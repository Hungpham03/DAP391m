...
def emotion_classification():
    ...
    if request.method == 'POST':
        ...
        predicted_emotion, confidence_score, fig, processed_text  = perform_emotion_classification(input_text)
        
        return render_template('emotion_classification.html', predicted_emotion=predicted_emotion, confidence_score=confidence_score, input_text=input_text, plot=fig.to_html(),processed_text=processed_text)
